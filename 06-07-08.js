...
function crearClasePersona() {
  class Persona {
    ...
    addFriend(nombre, edad) {
      ...
      Array.prototype.push.apply(this.amigos, amigoNuevo)
    }
    ...
    getFriends() {
      ...
      // Tu código aca:
      let nombreAmigo = this.amigos.map((amigos) => amigos.nombre);
      return nombreAmigo;
    ...
    getPromedioEdad() {
      ...
      var promedio = this.amigos.reduce(function(acumulador, siguienteValor){
